...
// Here is the test for sum(); uncomment it tdo run it. LINE COMPLETE.
testSum(4, 7);
...
function multiplyArray(multArr) { //eslint-disable-line
  var productMultArr = 1;
  var i;
  for (i = 1; i < multArr.length; i++) {
    productMultArr *= i;
  }
  var multArrString = 'The numbers ' + multArr[0] + ',' + multArr[1] + ',' + multArr[2] + ' have a product of ' + productMultArr + '.';

  console.log(productMultArr, multArrString);
  return [productMultArr, multArrString];
}
